...
# def description(weather_hash)
#     "The weather in #{weather_hash[:city]} is #{weather_hash[:description]}. The temperature is #{weather_hash[:temperature_farenheit]} degrees Farenheit."
# end
#puts description(weather)
...
weather.each do |city, description, temperature_farenheit|
    puts "The city is #{weather[:city]}. The description is #{weather[:description]}. The temperature is #{weather[:temperature_farenheit]}."
end
